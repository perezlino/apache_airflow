...
# están posteriormente (downstream tasks) a una tarea que se ha saltado también se 
...
with DAG('xcom_dag', start_date=datetime(2022,1,1), 
    ...
    # Agregamos una cuarta tarea
    t4 = BashOperator(
        task_id = 't4',
        bash_command ="echo ''",
        # Para modificar el comportamiento utilizamos "trigger rules". En
        # este caso, si una de las tareas ha tenido éxito y las otras han 
        # sido saltadas, entonces task 4 se dispara.
